...
class FutureBuilder<T> extends StatefulWidget {
  ...
  FutureBuilder({super.key, required this.future, required this.builder, this.initialData});
  ...
  void _subscribe() {
    ...
    widget.future!.then((T data) {
      if (_activeCallbackIdentity == callbackIdentity) {
        setState(() => _snapshot = AsyncSnapshot.withData(ConnectionState.done, data));
      }
    }, onError: (Object error, StackTrace stackTrace) {
      if (_activeCallbackIdentity == callbackIdentity) {
        setState(() => _snapshot = AsyncSnapshot.withError(ConnectionState.done, error, stackTrace));
      }
    });
    if (_snapshot.connectionState != .done) {
