...
/*
    ...
    return TextStyle(
      ...
      foreground: (a.foreground != null || b.foreground != null)
          ? t < 0.5
                ? a.foreground ?? (ui.Paint()..color = a.color!)
                : b.foreground ?? (ui.Paint()..color = b.color!)
          : null,
      background: (a.background != null || b.background != null)
          ? t < 0.5
                ? a.background ?? (ui.Paint()..color = a.backgroundColor!)
                : b.background ?? (ui.Paint()..color = b.backgroundColor!)
          : null,
